document.addEventListener('DOMContentLoaded', function () {
    ...
    function validateAuto() {
        ...
        else if (!NAME_RE.test(name)) { setError('fullName', 'Please enter your first and last name using letters only.'); valid = false; }
    ...
    function validateHome() {
        ...
        else if (!NAME_RE.test(name)) { setError('homeFullName', 'Please enter your first and last name using letters only.'); valid = false; }
    ...
    function validateLife() {
        ...
        else if (!NAME_RE.test(name)) { setError('lifeFullName', 'Please enter your first and last name using letters only.'); valid = false; }
